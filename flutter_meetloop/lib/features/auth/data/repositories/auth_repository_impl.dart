...
class AuthRepositoryImpl implements AuthRepository {
  ...
  @override
  Stream<UserEntity?> get authStateChanges => _remoteDatasource.gameStateStreamMap;

  Stream<UserEntity?> get _remoteDatasourceChanges {
    return _remoteDatasource.authStateChanges.map((model) => model);
  }
  ...
  @override
  Stream<UserEntity?> get gameStateStreamMap {
    return _remoteDatasource.authStateChanges.map((model) => model);
  }
}
